...
function MyApp({ Component, pageProps }) {
  ...
  return <div className="bg-white-100 relative" onClick={() => {
    ...
    <div className={`${router.pathname === "/" ? "top-64 md:top-52 lg:top-52 left-[44%] md:left-10 lg:left-32 h-[60px] w-[60px] rounded-2xl" : "top-5 rounded-xl left-[20%]   md:left-[25%] lg:left-[35%]"} bg-red-50 text-red-600 hover:bg-red-100  p-2 text-bold duration-300 fixed  z-[51] `}>
